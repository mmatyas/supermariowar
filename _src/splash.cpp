...
bool LoadAndSplashScreen()
{
	...
	"Stephan Peijnik", "ventuz", "Stefan Schury", "DrJonez", "riahc3",
	...
	"Fernando Marquez", "DrJones", "SleepyP", "Jared", "UltimateNinja9",
	...
	"Dude", "Sgraff87", "Justinio", "Matthew Callis", "VenomousNinja",
