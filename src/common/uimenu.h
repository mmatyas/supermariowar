...
enum MenuCodeEnum {
	...
	MENU_CODE_NET_ADDREMOVE_SERVER_ON_ADD,
	MENU_CODE_NET_ADDREMOVE_SERVER_ON_EDIT,
	MENU_CODE_NET_ADDREMOVE_SERVER_ON_DELETE,
	MENU_CODE_NET_ADDREMOVE_SERVER_ON_SELECT,
	MENU_CODE_NET_ADDREMOVE_SERVER_ON_DIALOG_OK,
