...
void MixDeleter::operator()(MIX_Audio* ptr) const noexcept { MIX_DestroyAudio(ptr); }


bool sfx_init()
{
    /*if (!MIX_Init())
        throw std::format("Could not initialize SDL mixer: {}", SDL_GetError());
