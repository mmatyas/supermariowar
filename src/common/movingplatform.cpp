...
void MovingPlatform::update()
{
    ...
    fOldVelX = pPath->velX(0);
    fOldVelY = pPath->velY(0);
...
{
    short iTop = (short)pPath->posY(1) - iHalfHeight;

    if (iY + h < iTop)
        return false;

    short iBottom = (short)pPath->posY(1) + iHalfHeight;

    if (iY >= iBottom)
        return false;

    short iLeft = (short)pPath->posX(1) - iHalfWidth;
    short iRight = (short)pPath->posX(1) + iHalfWidth;
