...
int main(int argc, char *argv[])
{
	...
	rm->spr_worlditems = spr_worlditems;
	rm->spr_worlditempopup = spr_worldpopup;
	rm->spr_storedpowerupsmall = spr_storedpowerupsmall;
	rm->spr_worlditemssmall = spr_worlditemssmall;
	rm->spr_worlditemsplace = spr_worlditemsplace;
	rm->menu_dialog = menu_dialog;
	rm->menu_egg = menu_egg;
	rm->menu_stomp = menu_stomp;
	rm->menu_survival = menu_survival;
	rm->spr_phanto = spr_phanto;
	rm->menu_plain_field = menu_plain_field;
	rm->menu_slider_bar = menu_slider_bar;
	rm->spr_selectfield = spr_selectfield;
	rm->menu_verticalarrows = menu_verticalarrows;
	rm->spr_storedpoweruplarge = spr_storedpoweruplarge;
	rm->menu_mode_small = menu_mode_small;
	rm->menu_mode_large = menu_mode_large;
	rm->spr_thumbnail_warps[0] = spr_thumbnail_warps[0];
	rm->spr_thumbnail_warps[1] = spr_thumbnail_warps[1];
	rm->spr_thumbnail_mapitems[0] = spr_thumbnail_mapitems[0];
	rm->spr_thumbnail_mapitems[1] = spr_thumbnail_mapitems[1];
	rm->spr_tileanimation[1] = spr_tileanimation[1];
	rm->spr_tileanimation[2] = spr_tileanimation[2];
	rm->spr_blocks[1] = spr_blocks[1];
	rm->spr_blocks[2] = spr_blocks[2];
	rm->spr_unknowntile[1] = spr_unknowntile[1];
	rm->spr_unknowntile[2] = spr_unknowntile[2];
	rm->spr_hazard_fireball[1] = spr_hazard_fireball[1];
	rm->spr_hazard_fireball[2] = spr_hazard_fireball[2];
	rm->spr_hazard_rotodisc[1] = spr_hazard_rotodisc[1];
	rm->spr_hazard_rotodisc[2] = spr_hazard_rotodisc[2];
	rm->spr_hazard_bulletbill[1] = spr_hazard_bulletbill[1];
	rm->spr_hazard_bulletbill[2] = spr_hazard_bulletbill[2];
	rm->spr_hazard_flame[1] = spr_hazard_flame[1];
	rm->spr_hazard_flame[2] = spr_hazard_flame[2];
	rm->spr_hazard_pirhanaplant[1] = spr_hazard_pirhanaplant[1];
	rm->spr_hazard_pirhanaplant[2] = spr_hazard_pirhanaplant[2];
