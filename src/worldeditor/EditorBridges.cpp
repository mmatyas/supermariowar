...
void EditorBridges::onSetupKeypress(const SDL_KeyboardEvent& event)
{
...
void EditorBridges::onSetupMouseClick(const SDL_MouseButtonEvent& event)
{
...
void EditorBridges::renderSetup(CResourceManager& rm)
{
